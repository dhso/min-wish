...
<#include "/system/common/head.ftl" encoding="UTF-8">
<#include "/system/common/top_navigation_bar.ftl" encoding="UTF-8">
	<!-- BEGIN CONTAINER -->
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									...
									<div id="site_statistics_loading">
										...
										<img src="${baseUrl}/static/image/loading.gif" alt="loading" />
								...
								<div class="portlet-title">
									...
									<div class="tools">
										...
										<div class="btn-group pull-right" data-toggle="buttons-radio">
											...
											<a href="" class="btn blue mini active">Users</a> <a href=""
												class="btn blue mini">Orders</a>
									...
									<div id="region_statistics_content" class="hide">
										...
										<div class="btn-toolbar">
											...
											<div class="btn-group " data-toggle="buttons-radio">
												...
												<a href="" class="btn mini active">Users</a> <a href=""
													class="btn mini">Orders</a>

											</div>

											<div class="btn-group pull-right">

												<a href="" class="btn mini dropdown-toggle"
													data-toggle="dropdown"> Select Region <span
												...
												<div class="scroller" data-height="290px"
													...
													<div class="row-fluid">
														...
														<div class="span6 user-info">
															...
															<img alt="" src="${baseUrl}/static/image/avatar.png" />
						...
						<div class="span6">
							...
							<div class="portlet">
								...
								<div class="portlet-body" id="chats">
									...
									<div class="scroller" data-height="435px"
										data-always-visible="1" data-rail-visible1="1">

										<ul class="chats">

											<li class="in"><img class="avatar" alt=""
												src="${baseUrl}/static/image/avatar1.jpg" />

												<div class="message">

													<span class="arrow"></span> <a href="#" class="name">Bob
														Nilson</a> <span class="datetime">at Jul 25, 2012 11:09</span>

													<span class="body"> Lorem ipsum dolor sit amet,
											...
											<li class="out"><img class="avatar" alt=""
												src="${baseUrl}/static/image/avatar2.jpg" />

												<div class="message">

													<span class="arrow"></span> <a href="#" class="name">Lisa
														Wong</a> <span class="datetime">at Jul 25, 2012 11:09</span> <span
											...
											<li class="out"><img class="avatar" alt=""
												src="${baseUrl}/static/image/avatar3.jpg" />
	...
	<div class="footer">
		<div class="footer-inner">
			2013 &copy; Metronic by keenthemes.Collect from <a href="http://www.cssmoban.com/" title="网站模板" target="_blank">网站模板</a> - More Templates
		</div>
